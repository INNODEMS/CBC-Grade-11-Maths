...
// Define the four function types from the domain rules table
const functions = [
    {
        label: 'f(x) = 0.3x\u00B2 \u2212 1',
        fn: (x) => 0.3 * x * x - 1,
...
// Slider to choose an input value to test
...
// Test the current x-value against the current function
...
// Switch which function is being tested
...
// Buttons to choose the function type
...
// Load the first function on start
switchFunction(0);